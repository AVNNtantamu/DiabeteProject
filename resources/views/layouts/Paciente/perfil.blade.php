        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="tab-content pt-2">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 label ">Nome do registo</div>
                    ...
                    <form>
                        ...
                        <div class="row mb-3">
                        <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Nome do Registo</label>
                    ...
                    <form>
                        ...
                        <div class="text-center">
                        <button type="submit" class="btn btn-primary">Trocar Palavra Passe</button>
                        </div>
